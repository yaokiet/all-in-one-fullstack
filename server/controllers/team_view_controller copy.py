...
def view_team_arrangements_in_date_range():
    ...
    daily_data = {day: {'in_office_count': 0, 'wfh_count': 0, 'total_members': len(team_members), 'schedules': []} for day in date_range}
        ...
        if arrangements_response.status_code == 200:
            ...
            for arrangement in arrangements:
                ...
                if arrangement_date in daily_data:
                    ...
                    # Add this member's arrangement to the schedule for the day
                    daily_data[arrangement_date]['schedules'].append({
                        'member_name': member['staff_id'],
